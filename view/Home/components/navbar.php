            ...
            <div class="inline my-2 my-lg-0">
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item mr-2">
                        <a class="nav-link" href="../index.php"><i class="bi-house-fill"></i> Início</a>
                    </li>
                    ...
                    ?>
                        <li class="nav-item mr-2">
                            <a class="nav-link btn btn-sm btn-light text-primary" href="./Login/"><i class="bi-person-fill"></i> Login</a>
                        </li>
                    <?php
                        endif;
                    ?>
